...
#
# Generated by export_simulation on Tue Jul 05 16:35:55 UTC 2022
#
################################################################################
...
'-reset_run' switch to the './edt_zcu106.sh' script.

./edt_zcu106.sh -reset_run
...
./edt_zcu106.sh -noclean_files

For more information on the script, please type './edt_zcu106.sh -help'.
