...
HD_PWD='/home/jkl-rpu/design_example_1/design_example_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log edt_zcu106_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source edt_zcu106_wrapper.tcl -notrace
